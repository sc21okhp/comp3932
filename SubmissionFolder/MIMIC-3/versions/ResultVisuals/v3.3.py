...
dynamic_auc_df = pd.read_csv('MIMIC-3/results/dynamic_auc.csv', index_col='Model')
...
def bestLine(df, metric_title, metric_name):
    markers = ['v', '^', '<', '>', 's', 'o']
    ...
    columns = ['Bagging', 'Boosting', 'RFC', 'CPH', 'RSF']
    new_df = df.loc[columns, time_points]
...
# meanAndSdBar(weighted_f1_df, 'Mean And Standard Deviation Weighted F1 Score Of Models', 'Mean Weighted F1 Probability')
# meanAndSdBar(roc_auc_df, 'Mean And Standard Deviation ROC-AUC Of Models', 'Mean ROC-AUC Probability')
# meanAndSdBar(brier_score_df, 'Mean And Standard Deviation Brier Score Of Models', 'Mean Brier Score Probability')

# ibsAndCIndexBar(ibs_df, c_index_df)

bestLine(accuracy_df, 'Point Accuracy Of Best Models', 'Accuracy')
bestLine(weighted_f1_df, 'Weighted F1 Score Of Best Models', 'Weighted F1')
bestLine(roc_auc_df, 'ROC-AUC Of Best Models', 'ROC-AUC')
bestLine(brier_score_df, 'Brier Score Of Best Models', 'Brier Score')