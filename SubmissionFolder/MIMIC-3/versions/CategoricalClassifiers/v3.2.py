...
def main():
    ...
    for name, (model, params) in classifiers.items():
        ...
        first_tune_model, new_params = tune_model(model, 
                                                  params, 
                                                  X_train_full, 
                                                  Y_train_full, 
                                                  cv=ps, 
        ...
        second_tune_model, final_params = tune_model(first_tune_model, 
                                                     wrapped_params, 
                                                     X_train_full, 
                                                     Y_train_full, 
                                                     cv=5, 
    ...
    for classifier in range(len(classifiers)):
        temp.append(classifiers[classifier] + ' (' + str(round(acc_list[classifier], 4)) + ')')
    ...
    temp = []
    for classifier in range(len(classifiers)):
        temp.append(classifiers[classifier] + ' (' + str(round(weighted_f1_list[classifier], 4)) + ')')
    ...
    temp = []
    for classifier in range(len(classifiers)):
        temp.append(classifiers[classifier] + ' (' + str(round(auc_list[classifier], 4)) + ')')
    ...
    temp = []
    for classifier in range(len(classifiers)):
        temp.append(classifiers[classifier] + ' (' + str(round(brier_list[classifier], 4)) + ')')
